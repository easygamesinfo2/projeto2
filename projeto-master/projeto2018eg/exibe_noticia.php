...
<body style="background-color: #2B2B2B">
	...
	<div style="margin-left: 20%; margin-right: 20%">
			...
			<div class="ui two column grid" style="margin-top: 5%">
				...
				?>
				<div class="column" >
					<div class="ui  segment" style=";background-color: #191919; margin-left: -60%">
                 ...
                 <a href="editar_noticia.php?id=<?= $noticia->getId(); ?>">Editar</a>
                 <a href="exclui_noticia.php?id=<?= $noticia->getId(); ?>">Excluir</a>
